...
train = tf.keras.preprocessing.image_dataset_from_directory(
	...
	labels="inferred", image_size=(64, 64), color_mode="grayscale"
	, shuffle=True)
test = tf.keras.preprocessing.image_dataset_from_directory(
	...
	labels="inferred", image_size=(64, 64), shuffle=True, color_mode="grayscale")
...
model.fit(train, validation_data=test, batch_size=2, shuffle=True, epochs=10)
model.summary()
